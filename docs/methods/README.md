...
<table><thead><tr><th width="200">Поле</th><th width="100" align="center">Тип</th><th>Описание</th></tr></thead><tbody><tr><td>reload_supported</td><td align="center">boolean</td><td>Необязательно. True, если текущее мини-приложение поддерживает собственную перезагрузку.</td></tr></tbody></table>
...
| type | <h4>PopupButtonType</h4> | Тип кнопки. "default", "destructive", "ok", "close", "cancel"                                                      |
