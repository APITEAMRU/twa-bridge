import { TG_WEB, TG_DESKTOP, TG_PHONE, sender, NOT_SUPPORTED, debug, MethodOpenInvoice } from "../index";
...
const openInvoice: OpenInvoice = (eventData) => {
  if (!supportOpenInvoice()) { debug(MethodOpenInvoice, 1); return { status: NOT_SUPPORTED } }
