import { TG_WEB, TG_DESKTOP, TG_PHONE, sender, NOT_SUPPORTED, debug, EventsData, listener, MethodReadTextFromClipboard, EventClipboardTextReceived } from "../../index";
...
const readTextFromClipboard: ReadTextFromClipboard = async (eventData) => {
  if (!supportReadTextFromClipboard()) { debug(MethodReadTextFromClipboard, 1); return { status: NOT_SUPPORTED } }
