import { TG_WEB, TG_DESKTOP, TG_PHONE, sender, NOT_SUPPORTED, debug, MethodSetHeaderColor } from "../index";
...
const setHeaderColor: SetHeaderColor = (eventData) => {
  if (!supportSetHeaderColor()) { debug(MethodSetHeaderColor, 1); return { status: NOT_SUPPORTED } }
