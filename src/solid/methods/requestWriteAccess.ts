import { TG_WEB, TG_DESKTOP, TG_PHONE, sender, NOT_SUPPORTED, debug, MethodRequestWriteAccess } from "../index";
...
const requestWriteAccess: RequestWriteAccess = () => {
  if (!supportRequestWriteAccess()) { debug(MethodRequestWriteAccess, 1); return { status: NOT_SUPPORTED } }
