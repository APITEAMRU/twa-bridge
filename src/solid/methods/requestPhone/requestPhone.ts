import { EventPhoneRequested, MethodRequestPhone, NOT_SUPPORTED, TG_DESKTOP, TG_PHONE, TG_WEB, debug, listener, sender } from "../../index";
...
const requestPhone: RequestPhone = async () => {
  if (!supportRequestPhone()) { debug(MethodRequestPhone, 1); return { status: NOT_SUPPORTED } }
