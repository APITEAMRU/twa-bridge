import { TG_WEB, TG_DESKTOP, TG_PHONE, sender, NOT_SUPPORTED, debug, MethodOpenLink } from "../index";
...
const openLink: OpenLink = (eventData) => {
  if (!supportOpenLink()) { debug(MethodOpenLink, 1); return { status: NOT_SUPPORTED } }
