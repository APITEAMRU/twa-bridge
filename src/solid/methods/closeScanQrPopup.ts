import { TG_PHONE, sender, NOT_SUPPORTED, debug, MethodCloseScanQrPopup } from "../index";
...
const closeScanQrPopup: CloseScanQrPopup = () => {
  if (!supportCloseScanQrPopup()) { debug(MethodCloseScanQrPopup, 1); return { status: NOT_SUPPORTED } }
