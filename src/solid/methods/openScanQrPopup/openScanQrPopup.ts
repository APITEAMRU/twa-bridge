import { EventQrTextReceived, EventScanQrPopupClosed, EventsData, MethodOpenScanQrPopup, NOT_SUPPORTED, TG_PHONE, bridgeCloseScanQrPopup, debug, listener, sender } from "../../index"
...
const openScanQrPopup: OpenScanQrPopup = async (eventData) => {
  if (!supportOpenScanQrPopup()) { debug(MethodOpenScanQrPopup, 1); return { status: NOT_SUPPORTED } }
